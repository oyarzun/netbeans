...
if [ -z "$1" ] || [ -z "$2" ]|| [ -z "$3" ] || [ -z "$4" ] || [ -z "$5" ] || [ -z "$6" ] || [ -z "$7" ]; then
    echo "usage: $0 zipdir prefix buildnumber build_jdk7 build_jdk8 build_jdk11 binaryname mac_sign_idname app_sign_idname version_number [nb_locales]"
    echo ""
    ...
    echo "mac_sign_idname is required if the packages are to be signed, 0 if not"
    echo "app_sign_idname is required if the app bundle is to be signed, 0 if not"
